...
public class BeerServiceTest {
    ...
    @Test
    void whenAlreadyRegistraredBeerInformedThenAnExceptionShouldBeThrown() {
        // given
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenNoRegisteredBeerNameIsGivenThenThrowException() throws BeerNotFoundException {
        // given
        BeerDTO expectedFoundBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    void whenListBeerIsCalledThenReturnAListOfBeers() {
        ...
        MatcherAssert.assertThat(foundListBeersDTO, Matchers.is(Matchers.notNullValue()));
        MatcherAssert.assertThat(foundListBeersDTO, Matchers.hasSize(1));
